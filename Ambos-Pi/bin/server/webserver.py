...
subprocess.call("/home/ambos/AMBOS-PbL/bin/server/closeApp")
sleep(2)
subprocess.call(['/home/ambos/AMBOS-PbL/bin/server/openApp','/home/ambos/AMBOS-PbL/data/order/current.json'])
